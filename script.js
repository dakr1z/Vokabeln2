...
/**
 * Zeigt die Dateiauswahl an und versteckt den Spielbereich
 */
function showFileSelection() {
    ...
    // Hide game content and show file selection
    gameContent.style.display = 'none';
    fileSelection.style.display = 'block';
    
    // On mobile, we need to ensure the file selection area is visible
    fileSelection.scrollIntoView({ behavior: 'smooth', block: 'center' });
}
